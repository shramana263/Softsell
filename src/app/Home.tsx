...
export default function Home() {
    ...
    return (
        <div className="flex min-h-screen flex-col">
            {/* Navigation */}
            <header className="lg:px-20 top-0 z-40 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
                <div className=" ps-10 pe-10 flex h-16 items-center justify-between">
...
type FormField = "name" | "email" | "company" | "licenseType" | "message";
